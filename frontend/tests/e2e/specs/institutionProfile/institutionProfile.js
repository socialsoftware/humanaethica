describe('InstitutionProfile', () => {
  ...
  it('create institution profile', () => {
    ...
    const REVIEW = 'Participation numa cãorrida da Demo Institution. O evento foi muito bem organizado, parabéns!'
    ...
    // verify that assessment with review is in row 0
    ...
    cy.get('[data-cy="institutionAssessmentsTable"] tbody tr')
      .eq(0) // click on first assessment
    ...
    // verify that assessment has "DEMO INSTITUTION" is in row 0
