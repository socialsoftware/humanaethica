...
class GetActivitiesWebServiceIT extends SpockTest {
    ...
    def "get activities"() {
        ...
        response.get(1).startingDate.withNano(0) == DateHandler.toISOString(IN_TWO_DAYS).withNano(0)
        response.get(1).endingDate.withNano(0) == DateHandler.toISOString(IN_THREE_DAYS).withNano(0)
        response.get(1).applicationDeadline.withNano(0) == DateHandler.toISOString(IN_ONE_DAY).withNano(0)
