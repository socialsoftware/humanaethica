...
class ActivityTest extends SpockTest {
    ...
    def "create empty activity"() {
        ...
        activity = new Activity("", "", 2, "", institution, "", "", "" ,Activity.State.APPROVED)
    ...
    def "create activity and persists"() {
        ...
        activity = new Activity("ACTIVITY_1_NAME", "ACTIVITY_1_REGION", 2, "ACTIVITY_1_DESCRIPTION", institution, "", "", "", Activity.State.APPROVED)
        activityRepository.save(activity)
        activity.addTheme(theme)
